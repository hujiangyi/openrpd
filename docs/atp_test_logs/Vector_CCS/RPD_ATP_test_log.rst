...
CCAP: Vector CCS, software release: ccap-dev-b328 (approx) 
...
+-----------------------------------------------------------+----------------+
|   Build # 1424 - created Feb 1, 2018                      | Feb 1, 2018    |
|   Git Hash - b360cd92a426d9579945049c1d78d23faa27d2f4     |                |
|   Notes - Tests run during Jan 2018 RPHY Interop          |                |
+-----------------------------------------------------------+----------------+
|   Build # 1861 - created Sept. 20, 2018                   | Sep 19, 2018   |
|   Git Hash - gb3390bc   OpenRPD Version 1.1.0-50          |                |
|   Notes - Tests run by Steve W. w/ Vector CCS to get a    |                |
|           baseline with current OpenRPD VM. The test      |                |
|           procedure included a significant manual hack to |                |
|           OpenRPD python code to handle the ResourceSet   |                |
|           TLV sent by the CCS.                            |                |
+-----------------------------------------------------------+----------------+
+============================================================================+
...
| Description                                               | Result         |
+-----------------------------------------------------------+----------------+
| Procedure 2.1: RPD IPv4 Address Acquisition               | 7P-9F-0S-0B    |
+-----------------------------------------------------------+----------------+
| Procedure 2.2: RPD IPv4 Address Acquisition - No DHCP     | 1P-0F-0S-0B    |
| OFFER from Server                                         |                |
+-----------------------------------------------------------+----------------+
| Procedure 2.3: RPD IPv4 Address Acquisition - No DHCP     |                |
| ACK from Server                                           |                |
+-----------------------------------------------------------+----------------+
| Procedure 2.4: RPD IPv4 Address Acquisition - Required    | 1P-0F-0S-0B    |
| Fields Missing                                            |                |
+-----------------------------------------------------------+----------------+
...
+-----------------------------------------------------------+----------------+
| Procedure 6.2: Verifying Ethernet 802.3, 802.1Q, IPv4     | 2P-2F-0S-3B    |
| Headers for CCAP Core and RPD                             |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.3: Verifying IPv6 Headers between CCAP        | 0P-0F-0S-2B    |
| Core and RPD                                              |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.4: Verifying L2TPv3 Ctrl Messages - Ctrl      | 28P-1F-0S-2B   |
| Connection for pair of LCCE entities                      |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.5: L2TPv3 unicast R-DEPI Sessions between     | 28P-1F-0S-1B   |
| CCAP Core and RPD                                         |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.6: L2TPv3 DSCP Policy between CCAP Core       | 11P-1F-14S-0B  |
| and RPD                                                   |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.7: Verifying Mandatory AVPs in L2TPv3         | 74P-0F-8S-0B   |
| Ctrl Plane between LCCE Entities                          |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.8: R-DEPI Data Forwarding Plane R-DEPI        | 23P-3F-0S-0B   |
| MPT Sublayer                                              |                |
+-----------------------------------------------------------+----------------+
| Procedure 6.9: R-DEPI Data Forwarding Plane R- DEPI       | 37P-1F-2S-0B   |
| PSP Sublayer                                              |                |
+-----------------------------------------------------------+----------------+
...
| Description                                               | Result         |
+-----------------------------------------------------------+----------------+
| Procedure 7.1: The R-UEPI L2TPv3 Ethernet 802.3 and       | 36P-2F-0S-0B   |
| IPv4 Headers                                              |                |
+-----------------------------------------------------------+----------------+
| Procedure 7.2: The R-UEPI L2TPv3 Ethernet 802.3 and       | 0P-0F-0S-24B   |
| IPv6 Headers                                              |                |
+-----------------------------------------------------------+----------------+
